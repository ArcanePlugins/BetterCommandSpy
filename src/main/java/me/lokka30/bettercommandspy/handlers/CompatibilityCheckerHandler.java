...
public class CompatibilityCheckerHandler {
     ...
     */
    public void scan() {
        Utils.LOGGER.info("Starting compatibility checker...");

        scanServerMCVersion();

        Utils.LOGGER.info("Compatibility checks completed.");
    }
    ...
    private void scanServerMCVersion() {
        ...
        Utils.LOGGER.info("Checking compatibility category '&b" + CompatibilityCategory.SERVER_MINECRAFT_VERSION + "&7'...");
